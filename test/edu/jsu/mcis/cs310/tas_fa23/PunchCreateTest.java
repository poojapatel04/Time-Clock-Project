...
public class PunchCreateTest {
    ...
    public void testCreatePunch3() {
        ...
        Punch p5 = new Punch(103, badgeDAO.find("8D9E5710"), EventType.CLOCK_IN);
        ...
        assertEquals(terminalid, p6.getTerminalid().intValue());
    ...
    public void testCreatePunch4() {
        ...
        assertEquals(terminalid, p8.getTerminalid().intValue());
    ...
    public void testCreatePunch5() {
        ...
        assertEquals(terminalid, p10.getTerminalid().intValue());
